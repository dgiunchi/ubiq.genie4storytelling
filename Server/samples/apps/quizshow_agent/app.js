...
const { TextToSpeechService, QuizHelperService, SpeechToTextService } = require("ubiq-genie-services");
const fs = require("fs");
const nconf = require("nconf");

class QuizShoqAgent extends ApplicationController {
    ...
    registerComponents() {
        ...
        this.components.textGenerationService = new QuizHelperService(this.scene, nconf.get());
...
module.exports = { QuizShoqAgent };

if (require.main === module) {
    const app = new QuizShoqAgent();
    app.start();
}
